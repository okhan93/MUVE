    ...
    <link rel="stylesheet" href={{asset('leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.css')}}>
    <link rel="stylesheet" href={{asset('css/bootleaf-app.css')}}>
  ...
  <body>
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">MUVE</a>
        </div>
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" id="downloadDrop" href="#" role="button" data-toggle="dropdown"><i class="fa fa-cloud-download white"></i>&nbsp;&nbsp; <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="data/boroughs.geojson" download="boroughs.geojson" target="_blank" data-toggle="collapse" data-target=".navbar-collapse.in"><i class="fa fa-download"></i>&nbsp;&nbsp;</a></li>
                  <li><a href="data/subways.geojson" download="subways.geojson" target="_blank" data-toggle="collapse" data-target=".navbar-collapse.in"><i class="fa fa-download"></i>&nbsp;&nbsp;</a></li>
                  <li><a href="data/DOITT_THEATER_01_13SEPT2010.geojson" download="theaters.geojson" target="_blank" data-toggle="collapse" data-target=".navbar-collapse.in"><i class="fa fa-download"></i>&nbsp;&nbsp;</a></li>
                  <li><a href="data/DOITT_MUSEUM_01_13SEPT2010.geojson" download="museums.geojson" target="_blank" data-toggle="collapse" data-target=".navbar-collapse.in"><i class="fa fa-download"></i>&nbsp;&nbsp;</a></li>
                </ul>
            </li>
          ...
          <div class="modal-body">
            <ul class="nav nav-tabs nav-justified" id="aboutTabs">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#boroughs-tab" data-toggle="tab"></a></li>
                  <li><a href="#subway-lines-tab" data-toggle="tab"></a></li>
                  <li><a href="#theaters-tab" data-toggle="tab"></a></li>
                  <li><a href="#museums-tab" data-toggle="tab"></a></li>
                </ul>
              </li>
            </ul>
    ...
    <script src="{{URL::to('leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.js')}}"></script>
    <script src="{{URL::to('js/bootleaf-app.js')}}"></script>
  </body>
</html>
